// Safari port of options.js; diffs: hosts already granted upfront in safari/manifest.json, so the runtime permissions.request is a best-effort no-op kept for parity.
