// Safari port of loop.js; diffs: snapshot tool description says Safari instead of Chrome.
const TOOLS = [
  ...
  { type: "function", function: { name: "snapshot", description: "Snapshot the attached Safari tab via Clip sidecar.", parameters: { type: "object", properties: {}, additionalProperties: false } } },
