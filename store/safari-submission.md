# App Store submission kit — FR!sky Paperclip for Safari 0.4.0
...
- `dist/frisky-paperclip-0.4.0-safari.zip` (built by
...
- `dist/frisky-paperclip-0.4.0-safari.zip` — extension payload for the
