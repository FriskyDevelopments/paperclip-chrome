# Edge Add-ons submission runbook — FR!sky Paperclip 0.7.0
...
## Readiness verdict: GO with the same 0.7.0 zip
...
- `dist/frisky-paperclip-0.7.0-edge.zip` — byte copy of the CWS 0.7.0 package
